...
const StudentProfilePage = ({ currentUser, onNavigate, onLogout }) => {
    ...
    return (
        <div className="min-h-screen bg-[#FDFBF7] siyasat-contour-lines text-[#800000]  relative overflow-x-hidden selection:bg-[#800000] selection:text-white pb-16">
                        ...
                        <div className="flex items-center space-x-5">
                            <div className="w-16 h-16 rounded-full bg-[#800000] text-[#F5B842] font-black text-2xl flex items-center justify-center shadow-md overflow-hidden">
                                {currentUser?.profile_image ? (
                                    <img src={`https://siyasat-backend.onrender.com/${currentUser.profile_image}`} alt="Profile" className="w-full h-full object-cover" />
                                ) : (
